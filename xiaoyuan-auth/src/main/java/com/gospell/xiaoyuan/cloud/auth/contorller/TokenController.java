package com.gospell.xiaoyuan.cloud.auth.contorller;
...
public class TokenController {
	//private static final String BASE_OAUTH_ACCESS = SecurityConstants.XIAOYUAN_PREFIX + SecurityConstants.OAUTH_PREFIX + "auth_to_access:*";
