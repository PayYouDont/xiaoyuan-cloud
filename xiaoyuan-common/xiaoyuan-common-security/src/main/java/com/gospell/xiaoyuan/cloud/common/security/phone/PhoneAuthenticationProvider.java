...
import com.gospell.xiaoyuan.cloud.common.security.component.BasePreAuthenticationChecks;
...
public class PhoneAuthenticationProvider implements AuthenticationProvider {
	...
	public Authentication authenticate(Authentication authentication) {
		...
		UserDetails userDetails = userDetailsService.loadUserByWxOpenId (principal);
		if (userDetails == null) {
