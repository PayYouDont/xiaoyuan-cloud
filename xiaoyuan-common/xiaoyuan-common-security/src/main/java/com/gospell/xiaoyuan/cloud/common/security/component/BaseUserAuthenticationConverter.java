...
public class BaseUserAuthenticationConverter implements UserAuthenticationConverter {
	...
	public Authentication extractAuthentication(Map<String, ?> map) {
		if (map.containsKey(USERNAME)) {
            ...
            Long id =  Long.valueOf (map.get(SecurityConstants.DETAILS_USER_ID).toString ());
			Long organId = Long.valueOf (map.get(SecurityConstants.DETAILS_ORGAN_ID).toString ());
            BaseUser user = new BaseUser(id, organId,username, N_A, true
